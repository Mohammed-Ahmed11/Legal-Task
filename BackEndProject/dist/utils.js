...
exports.detectTypeFromText = detectTypeFromText;
...
function detectTypeFromText(text) {
    ...
    if (/قانون|نظام|قرار|مادة|تشريع|لائحة/i.test(t))
        return 'legislation';
    if (/محكمة|قضية|حكم|الاستئناف|الهيئة/i.test(t))
        return 'judgment';
    if (/فتوى|إفتاء|الجواب|السؤال/i.test(t))
        return 'fatwa';
    return null;
}
